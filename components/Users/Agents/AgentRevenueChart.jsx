...
export default function AgentRevenueChart({ payments = [], isLoading }) {
        ...
        {isLoading ? (
          ...
          <ResponsiveContainer width="100%" height="100%">
            <ComposedChart data={data} margin={{ top: 8, right: 8, left: 8, bottom: 0 }}>
              <defs>
                <linearGradient id="agentRevenueFill" x1="0" y1="0" x2="0" y2="1">
