  ...
  return (
    <div className="py-4">
      <Disclosure>
        {({ open }) => (
          <>
            <Disclosure.Button className="flex justify-between w-full px-4 py-2 text-left text-gray-900 bg-black border-b hover:bg-gray-700 ">
              <div>
                <p className="text-white ">Liste des sections</p>
              </div>
              <RiArrowUpSLine
                className={`${
